...
$tanggal = $_GET['export_start'] ?? $_GET['tanggal'] ?? date('Y-m-d');
...
<h3>Preview: <?= format_tanggal($tanggal) ?></h3>
...
<a href="export_excel.php?jenis=harian&tanggal=<?= htmlspecialchars($tanggal) ?>" class="btn btn-primary">
